...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("42c93a91-0102-5b3f-8f9d-e41de60ac950"))
...
if best_platform === nothing
    @debug("Unable to load Libepoxy; unsupported platform $(triplet(platform_key_abi()))")
else
