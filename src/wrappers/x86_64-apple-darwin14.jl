# Autogenerated wrapper script for Libepoxy_jll for x86_64-apple-darwin14
export libepoxy
...
const libepoxy_splitpath = ["lib", "libepoxy.0.dylib"]
...
const libepoxy = "@rpath/libepoxy.0.dylib"
